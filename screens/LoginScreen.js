    ...
    <View className="flex-1 bg-white" style={{backgroundColor: themeColors.bg}}>
      ...
      >
        ...
        <View className="form space-y-2">
          ...
          <TextInput 
            className="p-2 bg-gray-100 text-gray-800 rounded-2xl mb-2 border-2"
            placeholder="Ex.: nikoRodriguez@gmail.com"
          />
          ...
          <TouchableOpacity className="py-3 bg-green-500 rounded-xl">
            <Text className="text-xl font-bold text-center text-gray-800">Login</Text>
          </TouchableOpacity>
